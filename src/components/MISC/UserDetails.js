				...
				<div className="col-sm-12">
					<div className="row">
						<table width="100%" border="0" className="noBorder noStripe col-table-4 cellGap">
							<tbody>
								<tr>
								<td className="bgHighlt" width="12%">User ID<br/>
									<input type="text" name="mZip" placeholder="Admin" value={this.state.mZip} onChange={this.handleChange} /></td>	
								<td className="bgHighlt">PIN#<br/>
									<input type="text" name="mZip" placeholder="Pin" value={this.state.mZip} onChange={this.handleChange} /></td>
									<td></td>
									<td></td>
								</tr>								
							</tbody>
